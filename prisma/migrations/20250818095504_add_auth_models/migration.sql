...
VALUES ('default-user', 'Default User', 'default@example.com', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- 为Todo表添加userId列，并设置默认值
ALTER TABLE "public"."Todo" ADD COLUMN "userId" TEXT NOT NULL DEFAULT 'default-user';
