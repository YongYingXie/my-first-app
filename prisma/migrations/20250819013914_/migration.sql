...
VALUES ('default-user-id', 'Default User', 'default@example.com', 'hashed-password-placeholder', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- Add userId column to Todo table
ALTER TABLE "public"."Todo" ADD COLUMN "userId" TEXT NOT NULL DEFAULT 'default-user-id';

-- Update existing todos to use the default user
UPDATE "public"."Todo" SET "userId" = 'default-user-id' WHERE "userId" = 'default-user-id';
